...
export default function Sidebar({ onClose }) {
  ...
  return (
    <aside className="h-full w-64 flex flex-col border-r border-white/5 bg-slate-950 lg:bg-slate-950/50 backdrop-blur-xl">
      {/* Logo */}
      <div className="p-8">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center shadow-[0_0_20px_rgba(99,102,241,0.2)]">
